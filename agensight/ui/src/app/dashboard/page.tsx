...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (versionsData) {
      const filteredVersions = versionsData.filter(
        (v: ConfigVersion) =>
          ...
          <div className="flex items-center justify-center h-screen">
            <div className="text-center">
              <p className="text-red-500">
                {versionsError?.message || configError?.message}
              </p>
            </div>
          </div>
        </SidebarInset>
  ...
  return (
    <div className="min-h-screen flex flex-col">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        ...
                        <IconVersions
                          size={16}
                          className="mr-1 group-hover:text-primary transition-colors duration-300"
                        />
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4 px-6">
            <div className="space-y-2">
              <Label htmlFor="commit-message" className="font-medium">
                Commit Message
              </Label>
              <Input
                id="commit-message"
          ...
          <DialogFooter>
            ...
            <Button disabled={versionsLoading} onClick={handleCommit}>
              {versionsLoading ? (
                <>
      ...
      <Dialog open={isAgentModalOpen} onOpenChange={setIsAgentModalOpen}>
        <DialogContent
          className="sm:max-w-[600px] max-h-[80vh] overflow-hidden border-0 !border-none bg-card/90 backdrop-blur-sm shadow-lg"
          style={{ border: 'none' }}
        >
          <DialogHeader
